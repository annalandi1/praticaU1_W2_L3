...
for(let i=0; i < starWarsCharacters.length; i++){
  ...
  switch(starWarsCharacters[i].eye_color){
    ...
    case "blue-gray":
     ...
     default:
     console.log("il personaggio di nome" +starWarsCharacters[i]+ "ha un colore di occhi non riconosciuto")
  }
...
console.log("ship is half loaded")
  ...
  console.log("ship is half loaded")
    ...
    console.log("Warning: Load over 700")
...
console.log("star wars modificato", starWarsCharacters)
/* --EXTRA-- ESERCIZIO 9
